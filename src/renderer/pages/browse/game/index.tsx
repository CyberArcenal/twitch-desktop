...
const GamePage: React.FC = () => {
  ...
  // Fetch streams when tab is streams
  useEffect(() => {
    ...
    <div className="min-h-screen bg-[var(--bg-base)]">
      ...
      <div className="relative h-64 md:h-80 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <img
            src={boxArtUrl}
            alt={game.name}
            className="w-32 h-40 md:w-40 md:h-52 rounded-lg shadow-2xl border-2 border-white/20"
          />
        </div>
        <button
          onClick={() => navigate(-1)}
          className="absolute top-4 left-4 z-30 bg-black/50 hover:bg-black/70 p-2 rounded-full transition"
        >
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-[#adadb8]">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>{streams.reduce((acc, s) => acc + s.viewer_count, 0).toLocaleString()} viewers</span>
            </div>
            <div className="flex items-center gap-1">
