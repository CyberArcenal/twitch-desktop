  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video bg-[#0e0e10] overflow-hidden">
        ...
        {/* Live badge (enhanced) */}
        <div className="absolute top-2 left-2 bg-gradient-to-r from-red-600 to-red-700 text-white text-xs font-bold px-2 py-0.5 rounded-full flex items-center gap-1 shadow-lg z-20">
