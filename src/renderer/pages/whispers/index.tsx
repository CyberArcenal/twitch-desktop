...
const WhispersPage: React.FC = () => {
  ...
  return (
    <div className="flex gap-4 h-full p-4 bg-[#0e0e10]">
      {/* Conversation list – rounded card */}
      <div className="w-80 flex-shrink-0 rounded-xl bg-gradient-to-b from-[#1f1f2b] to-[#18181b] border border-[#2a2a2e] overflow-hidden shadow-lg">
        <ConversationList
      ...
      {/* Chat area – rounded card */}
      <div className="flex-1 rounded-xl bg-[#1f1f23] border border-[#2a2a2e] overflow-hidden shadow-lg">
        {selectedConv ? (
          <ChatWindow
