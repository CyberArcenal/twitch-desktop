...
const ChatPanel: React.FC<ChatPanelProps> = ({ channelName, isLive }) => {
  ...
  return (
    <div className="bg-[#1f1f23] rounded-xl flex flex-col overflow-hidden flex-1 min-h-[300px]">
      ...
      <div className="p-3 border-t border-[#2a2a2e]">
        <div className="flex gap-2 mb-2">
          <input
            ...
            placeholder={isLive ? "Send a message..." : "Chat only available when live"}
            disabled={!isLive}
